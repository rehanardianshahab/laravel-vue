...
<h3 class="text-center">Data Pengarang</h3>
<a class="btn btn-md btn-info mb-n2 mt-1" href="add_pengarang.php"><i class="bi bi-plus-circle-dotted"></i> Add New Pengarang</a><br/><br/>
 ...
 <?php  
     while($pengarang_data = mysqli_fetch_array($pengarang)) {         
         ...
         echo "<td><a class='btn btn-sm btn-warning' href='edit_pengarang.php?id_pengarang=$pengarang_data[id_pengarang]'>Edit</a> | <a class='btn btn-sm btn-danger' href='delete_pengarang.php?id_pengarang=$pengarang_data[id_pengarang]'>Delete</a></td></tr>";        
     }
 ?>
 </table>
</div>
