                  ...
                  <div class="container-fluid">
                    <div class="row">
                      <div class="col-12">
                        <div class="card">
                          <div class="card-header">
                            <a href="{{ url('publishers') }}" class="card-title text-danger text-end d-block">Back</a>
                          </div>
                          <!-- /.card-header -->
...
@section('js')
  <script>
    ...
    let apiUrl = '{{ url('api/publishers/trash') }}';
          ...
          if (confirm('are you sure?')) {
            ...
            axios.post(actionUrl,{_method: 'get'}).then(response => {
              ...
              function (error) {
                ...
                $("#erorDelete").html("<div class='alert alert-success alert-dismissible fade show' role='alert'"+">"+
                          eror+
                          "<button type='button' class='btn-close' data-bs-dismiss='alert' aria-label='Close'></button"+">"+
                        "</div>");
              });
