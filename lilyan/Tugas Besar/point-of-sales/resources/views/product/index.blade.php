      ...
      <div class="col-12">
        <div class="card">
          <div class="card-header">
            ...
            <button @click="cetakBarcode('{{ route('products.cetak_barcode') }}')" class="btn btn-info"><i class="fa fa-barcode"></i>&nbsp; Cetak Barcode</button>
            {{-- <button @click="cetakMember()" class="btn btn-info"><i class="fa fa-id-card"></i>&nbsp; Cetak Member</button> --}}
                  ...
                  <label>Kategori</label>
                    ...
                    <option value="">Pilih Kategori</option>
                     @foreach ($categories as $category)
                         <option value="{{ $category->id }}" :selected="data.category_id">{{ $category->name_category }}</option>
                     @endforeach
                    </select>
                </div>
                <div class="form-group">
