...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
      ...
      <span class="brand-text font-weight-light">NiceStore</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'admin')): ?>
          <li class="nav-item">
            <a href="<?php echo e(url('categories')); ?>" class="nav-link <?php echo e(request()->is('categories') ? 'active' : ''); ?>">
          ...
          <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'admin')): ?>
          <li class="nav-item">
            <a href="<?php echo e(url('expenses')); ?>" class="nav-link <?php echo e(request()->is('expenses') ? 'active' : ''); ?>">
          ...
          <?php if(\Spatie\Permission\PermissionServiceProvider::bladeMethodWrapper('hasRole', 'admin')): ?>
          <li class="nav-item">
            <a href="<?php echo e(url('purchases')); ?>" class="nav-link <?php echo e(request()->is('purchases') ? 'active' : ''); ?>">
          ...
          <li class="nav-item">
            <a href="<?php echo e(url('settings')); ?>" class="nav-link <?php echo e(request()->is('settings') ? 'active' : ''); ?>">
              <i class="nav-icon fa-solid fa-screwdriver-wrench"></i></fa-solid>
              <p>Pengaturan Toko</p>
            </a>
          </li>
          <?php endif; ?>
  ...
  <footer class="main-footer">
    <strong>Copyright &copy; 2023 <a href="#">Lilyan Arhatia Agustine</a>.</strong>
    All rights reserved.
  </footer>
...
<?php /**PATH E:\Eduwork Bootcamp\laravel-vue\laravel-vue\lilyan\Tugas Besar\point-of-sales\resources\views/layouts/admin.blade.php ENDPATH**/ ?>