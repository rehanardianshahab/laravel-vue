...
<?php $__env->startSection('header', 'Transaksi Penjualan'); ?>
          ...
          <!-- /.card-header -->
            <div class="card-body">
              ...
              <div class="row">
                ...
                <div class="col-lg-4">
                  <form action="<?php echo e(route('transactions.store')); ?>" class="form-sales" method="post">
                    <?php echo csrf_field(); ?>
                    <input type="hidden" name="sale_id" id="sale_id" value="<?php echo e($sale_id); ?>">
...
<?php if ($__env->exists('sale_detail.product')) echo $__env->make('sale_detail.product', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php if ($__env->exists('sale_detail.member')) echo $__env->make('sale_detail.member', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
<?php $__env->stopSection(); ?>
...
<script type="text/javascript">
    ...
    $(function () {
        table = $('.table-sale').DataTable({
            ...
            autoWidth: false,
            ajax: {
                url: '<?php echo e(route('api.sale_details', $sale_id)); ?>',
            },
            columns: [
        ...
        $(document).on('input', '.quantity', function () {
          ...
          $.post(`<?php echo e(url('/sale_details')); ?>/${id}`, {
    ...
    function addProduct() {
        $.post('<?php echo e(route('sale_details.store')); ?>', $('.form-product').serialize())
            .done(response => {
                $('#product_code').focus();
                  table.ajax.reload(() => loadForm($('#discount').val()));
            })
    ...
    function selectMember(id, code) {
      ...
      $('#discount').val('<?php echo e($discount); ?>')
      loadForm($('#discount').val());
    ...
    function loadForm(discount = 0, cash = 0) {
        ...
        $.get(`<?php echo e(url('/sale_details/loadform')); ?>/${discount}/${$('.total').text()}/${cash}`)
            .done(response => {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Eduwork Bootcamp\laravel-vue\laravel-vue\lilyan\Tugas Besar\point-of-sales\resources\views/sale_detail/index.blade.php ENDPATH**/ ?>